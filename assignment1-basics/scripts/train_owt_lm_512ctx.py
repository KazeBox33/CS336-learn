...
@dataclass
class ModelConfig:
    model_name: str = "owt_transformer_512ctx_6layer"
...
class TrainingConfig:
    ...
    save_checkpoint_dir: str = "/root/autodl-tmp/cs336/outputs/owt_lm_512ctx_6layer"
    ...
    log_path: str = "/root/autodl-tmp/cs336/outputs/owt_lm_512ctx_6layer/train_log.jsonl"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a 512-context OpenWebText Transformer LM.")
