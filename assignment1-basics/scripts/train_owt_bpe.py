...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a byte-level BPE tokenizer on OpenWebText.")
    parser.add_argument("--input-path", type=Path, default=Path("../data/owt_train.txt"))
    parser.add_argument("--output-dir", type=Path, default=Path("../outputs/owt_bpe"))
